<?php // this is currently a placeholder and not functional yet - in need of a btter UI
...
<div class="wrap">
    ...
    <h2><?php _e('WP Universal Functions Settings', 'wp-universal-functions'); ?></h2>
    <?php if (isset($_GET['msg'])) : ?>
        <div id="message" class="updated below-h2">
            <?php if ($_GET['msg'] == 'update') : ?>
                <p><?php _e('Settings Updated.','wp-universal-functions'); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <form method="post">
        ...
        <div id="cpt_select_objects">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <p><?php _e('Check to Apply this functionality to your site', 'wp-universal-functions') ?></p>
                    </tr>
                    <tr>
                        <td>
                            <?php
