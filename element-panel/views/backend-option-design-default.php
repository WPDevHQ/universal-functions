...

{
	$classes = array(
		...
		'label' => array(
			...
			'responsive' => 'fw-col-xs-6 fw-col-sm-6 fw-col-lg-8',
		),
		'input' => array(
			'fw-backend-option-input',
			'fw-backend-option-input-type-'. $option['type'],
			'responsive' => 'fw-col-xs-6 fw-col-sm-6 fw-col-lg-4',
		),
		'desc' => array(
			'fw-backend-option-desc',
			'responsive' => 'fw-col-xs-12 fw-col-sm-offset-0 fw-col-sm-12 fw-col-lg-offset-0 fw-col-lg-12',
		),
	);
