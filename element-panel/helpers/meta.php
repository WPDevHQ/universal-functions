...
function fw_add_page_meta( $post_id, $meta_key, $meta_value, $unique = false ) {
	// Make sure meta is added to the post, not a revision. // fixme: why this is needed?
	/*if ( $the_post = wp_is_post_revision( $post_id ) ) {
		$post_id = $the_post;
	}*/

	return fw_add_metadata( 'page', $post_id, $meta_key, $meta_value, $unique );
}
...
function fw_update_page_meta( $post_id, $meta_key, $meta_value, $prev_value = '' ) {
	// Make sure meta is added to the post, not a revision. fixme: why this is needed?
	/*if ( $the_post = wp_is_post_revision( $post_id ) ) {
		$post_id = $the_post;
	}*/

	return fw_update_metadata( 'page', $post_id, $meta_key, $meta_value, $prev_value );
}
...
function fw_delete_page_meta( $post_id, $meta_key, $meta_value = '' ) {
	// Make sure meta is added to the post, not a revision. // fixme: why this is needed?
	/*if ( $the_post = wp_is_post_revision( $post_id ) ) {
		$post_id = $the_post;
	}*/

	return delete_metadata( 'page', $post_id, $meta_key, $meta_value );
}
